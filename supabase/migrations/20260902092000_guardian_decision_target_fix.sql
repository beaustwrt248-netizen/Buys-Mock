...
comment on function public.guardian_decide_incident(uuid,text) is
'Admin/Manager Guardian incident decision boundary. Targets only the selected incident and its repair record.';
