...
-- Phase 2 starts least-privileged: Admin/Manager only. Staff lifecycle permissions can be
-- added later through an explicit operational policy rather than inferred from UI access.
