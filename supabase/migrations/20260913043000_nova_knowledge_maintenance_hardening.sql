...
-- Reconcile the five-minute maintenance schedule during hardening rollouts.
-- The credential is read from Vault at execution time; no secret value is committed here.
do $block$
declare
  existing_job record;
begin
