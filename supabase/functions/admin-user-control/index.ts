...
Deno.serve(async(req:Request)=>{
  ...
  try{
    ...
    if(targetUser===user.id && ['disable','force_signout','delete','set_role'].includes(action)) return reply({error:'You cannot perform this action on your own active admin account'},400);
