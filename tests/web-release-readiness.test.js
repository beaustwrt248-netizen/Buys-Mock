...
assert.match(desktop, /const VALID=\['home','categories','mobilePhones','computer','console','laptop','desktop','general','settings'/);
...
assert.match(index, /quick-deal-grade\.js\?v=3/);
...
assert.match(quickDealGrade, /MAX_BUY_FACTOR=Object\.freeze\(\{A:\.70,B:\.50,C:\.30,Luxury:\.70\}\)/);
