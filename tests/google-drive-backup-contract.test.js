...
assert.match(src, /EXCLUDED_BACKUP_FIELDS/);
assert.match(src, /devices:\s*new Set\(\['fcm_token'\]\)/);
assert.match(src, /sanitizeBackupRow\(table, row as Record<string, unknown>\)/);
