...
test('v5 is the final production mobile CSS and JS authority',()=>{
  assert.match(index,/mobile-app-parity-v5\.css\?v=202609072/);
  assert.match(index,/mobile-app-parity-v5\.js\?v=202609041&route=2/);
  assert.ok(index.indexOf('mobile-app-parity-v5.css?v=202609072')>index.indexOf('mobile-app-parity-v4.css?v=202609044'));
