...
assert.match(app, /const requestVersion=\+\+refreshVersion/, 'permissions branch must preserve version-bound core refreshes');
...
assert.match(permissions, /let refreshVersion=0;/, 'permissions policy refresh must have an independent freshness token');
