...
test('control centre does not reload feature modules already inserted elsewhere',()=>{
  ...
  for(const name of ['live-memory.js','live-intelligence.js','pr-readiness.js','proactive-alerts.js','business-intelligence.js','pricing-intelligence.js','conversation.js']) assert.match(control,new RegExp(name.replace('.','\\.')));
});
...
test('control centre preserves deterministic feature dependency order',()=>{
  assert.match(control,/s\.async=false/);
