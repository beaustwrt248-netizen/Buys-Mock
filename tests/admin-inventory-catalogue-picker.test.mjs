...
assert.match(picker,/function clearSearchResults\(\)\{rows=\[\];const host=q\('#invCatalogueResults'\);if\(host\)host\.innerHTML=''\}/);
assert.match(picker,/searchVersion\+\+;clearSelectedCatalogue\(\);clearSearchResults\(\);clearTimeout\(timer\)/);
