...
assert.match(app, /action === 'check-updates'/, 'the Settings update control must have an application handler');
assert.match(app, /novanext:\/\/check-updates/, 'manual checks must invoke the narrow native OTA route');
