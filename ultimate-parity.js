...
function integrity(){
  ...
  const scope=['#home .tiles','nav','.desktop-side-nav','#computer','#console'].map(s=>$(s)?.textContent||'').join(' ').toLowerCase();
