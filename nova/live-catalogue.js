...
async function rows(){
  ...
  for(let offset=0;;offset+=PAGE_SIZE){
    const page=await window.NovaAuth.rest('/rest/v1/device_catalog?select=id,category,model_number,storage_options,release_year,image_reference_url,active,market_region&order=id.asc&limit='+PAGE_SIZE+'&offset='+offset);
