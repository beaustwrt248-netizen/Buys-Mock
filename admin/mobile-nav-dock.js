...
// Final authenticated mobile density/readability layer. It is deliberately loaded from the existing
// nav runtime so both the hosted Admin and Android WebView receive the same cache-busted assets.
(()=>{const load=()=>{if(!document.querySelector('#adminMobileDensityPolishCss')){const l=document.createElement('link');l.id='adminMobileDensityPolishCss';l.rel='stylesheet';l.href='mobile-density-polish.css?v=1';document.head.appendChild(l)}if(!document.querySelector('#adminMobileDensityPolishJs')){const s=document.createElement('script');s.id='adminMobileDensityPolishJs';s.src='mobile-density-polish.js?v=1';s.async=false;document.body.appendChild(s)}};if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',load,{once:true});else load()})();
