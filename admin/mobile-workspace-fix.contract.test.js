...
if(!home.includes('mobile-workspace-fix.css?v=2')||!home.includes('mobile-workspace-fix.js?v=2'))throw new Error('final mobile workspace authority is not loaded with the current cache version');
