...
async function authorise(){try{
 ...
 for(const src of ['morley-ai-core.js?v=1','nova-brand.js?v=1','morley-ai-ui.js?v=2','nova-training-ui.js?v=1','nova-knowledge-ui.js?v=1','nova-lifecycle-ui.js?v=1','nova-control-centre.js?v=3'])await loadScript(src);
