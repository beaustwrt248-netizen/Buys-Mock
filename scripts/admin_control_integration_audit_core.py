...
require('id="adminTurnstileFrame"' in admin_html, "Admin web isolated Turnstile frame is missing")
...
print("Verified stable isolated browser Admin auth with bounded recovery, native Android session ownership/workspaces, privileged API contracts and OTA governance.")