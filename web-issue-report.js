(()=>{
  ...
  function buildDiagnostics(){return {platform:'web',captured:new Date().toISOString(),page:`${location.origin}${location.pathname}`,browser:navigator.userAgent,online:navigator.onLine,viewport:`${window.innerWidth}x${window.innerHeight}`,screen:`${screen.width}x${screen.height}`,webDeployment:document.lastModified||'current'}}
