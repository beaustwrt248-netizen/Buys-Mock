...
old_activity = 'class MainActivity:ComponentActivity(){override fun onCreate(savedInstanceState:Bundle?){super.onCreate(savedInstanceState);window.statusBarColor=android.graphics.Color.rgb(17,17,17);window.navigationBarColor=android.graphics.Color.rgb(17,17,17);setContent{App()}}}'
new_activity = 'class MainActivity:ComponentActivity(){override fun onCreate(savedInstanceState:Bundle?){super.onCreate(savedInstanceState);AppRuntime.context=applicationContext;window.statusBarColor=android.graphics.Color.rgb(17,17,17);window.navigationBarColor=android.graphics.Color.rgb(17,17,17);setContent{App()}}}'
...
if old_activity in text:
    ...
    changed = True
elif new_activity not in text:
    raise SystemExit('Could not locate MainActivity initialisation for pricing auth migration')
...
if changed:
    ...
    print('Secured primary eBay/Google pricing API request')
else:
