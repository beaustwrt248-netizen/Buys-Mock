...
object AdminCopyrightFooter {
    ...
    private fun ensureFooter(activity: Activity) {
        ...
        val heightPx = (activity.resources.displayMetrics.density * 18f).toInt()
        val footer = TextView(activity).apply {
            tag = FOOTER_TAG
            text = "\u00a9 2026 Beau Stewart. All rights reserved."
            textSize = 9f
            gravity = Gravity.CENTER
            setTextColor(0xBE8EA6C4.toInt())
        ...
        content.addView(footer, FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, heightPx, Gravity.BOTTOM))
    }
}
