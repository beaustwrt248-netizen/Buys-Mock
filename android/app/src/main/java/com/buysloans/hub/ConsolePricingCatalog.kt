...
object ConsolePricingCatalog {
    val entries = listOf(
        ConsolePriceEntry("Sony PS4 OG 500gb", 129.0),
        ConsolePriceEntry("Sony PS4 OG 1tb", 159.0),
        ConsolePriceEntry("Sony PS4 Slim 500gb", 179.0),
        ConsolePriceEntry("Sony PS4 Slim 1tb", 199.0),
        ConsolePriceEntry("Sony PS4 Pro", 249.0),
        ConsolePriceEntry("Sony PS5 Digital", 449.0),
        ConsolePriceEntry("Sony PS5 Disc", 549.0),
        ConsolePriceEntry("Sony PS5 Digital Slim", 499.0),
        ConsolePriceEntry("Sony PS5 Slim Disc", 599.0),
        ConsolePriceEntry("Sony PS5 Pro", 899.0),
