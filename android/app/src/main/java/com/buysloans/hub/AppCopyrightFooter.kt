...
/**
 * Adds a small non-interactive copyright strip to every Activity without each
 * screen having to duplicate footer layout code.
 */
object AppCopyrightFooter {
    private const val FOOTER_TAG = "morley_copyright_footer"
    ...
    private fun ensureFooter(activity: Activity) {
        ...
        // Reserve a tiny strip so the footer does not cover bottom navigation,
        // buttons or scroll content.
